...
public class Triplet extends BEASTObject {
	...
	final public Input<String> parentStateInput = new Input<>("parentState", "Type (trait state) of parent.", Validate.REQUIRED);
	final public Input<String> leftChildInput = new Input<>("leftChildState", "Type (trait state) of left child.", Validate.REQUIRED);
	final public Input<String> rightChildInput = new Input<>("rightChildState", "Type (trait state) of right child.", Validate.REQUIRED);
	...
	private String[] cladogeneticEvent;
	private String tripletType;
	
	@Override
	public void initAndValidate() {
		cladogeneticEvent = new String[3];
